...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_SEL_ACCOUNT_VIP_POINTS,
    LOGIN_INS_ACCOUNT_VIP_POINTS,
    LOGIN_GET_VIPLEVEL_AND_POINTS,
    LOGIN_GET_VIPLEVEL_BY_REALMID,
    LOGIN_GET_POINTS_BY_REALMID,
    LOGIN_UPD_VIPLEVEL,
    LOGIN_UPD_POINTS,
    LOGIN_UPD_VIPLEVEL_POINTS,
