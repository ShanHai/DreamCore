...
int ObjectMgr::LoadReferenceVendor(int32 vendor, int32 item, std::set<uint32> *skip_vendors)
{
    ...
    do
    {
        ...
        else
        {
            ...
            vList.AddItem(item_id, maxcount, incrtime, ExtendedCost, points);
            ++count;
        }
    } while (result->NextRow());
...
void ObjectMgr::LoadVendors()
{
    ...
    QueryResult result = WorldDatabase.Query("SELECT entry, item, maxcount, incrtime, ExtendedCost, points FROM npc_vendor ORDER BY entry, slot ASC");
    if (!result)
    {
    ...
    do
    {
        ...
        else
        {
            ...
            uint32 points       = fields[5].GetUInt32();
...
void ObjectMgr::AddVendorItem(uint32 entry, uint32 item, int32 maxcount, uint32 incrtime, uint32 extendedCost, uint32 points /*= 0*/, bool persist /*= true*/)
{
    VendorItemData& vList = _cacheVendorItemStore[entry];
    vList.AddItem(item, maxcount, incrtime, extendedCost, points);
