...
void GuildMgr::LoadGuilds()
{
    ...
    TC_LOG_INFO("guild", "Filling bank tabs with items...");
    {
        ...
        QueryResult result = CharacterDatabase.Query("SELECT creatorGuid, giftCreatorGuid, count, duration, charges, flags, enchantments, randomPropertyId, durability, playedTime, text, fakeEntry, "
                                                     //   12       13     14      15         16
